...
function get_quoats() {
    ...
    if (random >= popular_quoats.length) { --random }
    var x = popular_quoats.splice(random, 1);
    quote.innerHTML = '"' + x[0].quoat + '"';
    author.innerHTML = x[0].author;
    popular_quoats.unshift(x[0]);
};
